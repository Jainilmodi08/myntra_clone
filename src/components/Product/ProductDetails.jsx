...
import { isItemAdded } from "../../utils/utilities";
          ...
          {/* image */}
            <div style={{ display: "flex", padding: "8px 18px 0px 1px" }}>
              <div style={{ width: "60%" }}>
                <Grid container>
                  {product?.image?.map((pic, id) => {
                    return (
                      <Grid item key={id} xs={12} sm={6} md={6} lg={6} xl={6}>
                        <div className={classes.imgContainer}>
                          <img className={classes.imgGrid} src={pic} alt="product_img"/>
                        </div>
                      </Grid>
                    );
                  })}
              ...
              <div style={{ width: "40%", paddingLeft: "20px" }}>
                ...
                {/* action area  */} 
                {/* all this buttons are not implemented logically rightnow*/}
